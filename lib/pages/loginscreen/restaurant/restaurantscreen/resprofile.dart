...
class _ResProfileState extends State<ResProfile> {
  ...
  final TextEditingController emailController = TextEditingController(text: 'taking.food@gmail.com');
  final TextEditingController nameController = TextEditingController(text: 'TAKING FOOD');
  final TextEditingController phoneController = TextEditingController(text: '0 850 505 55 00');
                ...
                Center(
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 20.0), // Reduced space before buttons
                      ElevatedButton(
                        onPressed: () {
              ...
              child: FloatingActionButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const ResAddScreen(), // Update with appropriate screen
                    ),
                  );
                },
                backgroundColor: Colors.transparent, // Transparent background
